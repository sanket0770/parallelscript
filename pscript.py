...
workspaces = ["https://github.com/sanket0770/parallelscript.git/workspace/workspace1", r"workspace/workspace2", r"workspace/workspace3"]  # Add your workspace directories here
